    ...
    <div class="px-5 lg:max-w-screen-lg mx-auto">
      <div class="text-center mb-2">
        ...
        <div class="block whitespace-pre-line text-gray-700 text-justify">
          ...
          En 2020, en parallèle de mon accompagnement à la création d’entreprise, j’obtiens la validation HACCP. Puis, je me forme à la transformation des fruits (CFPPA de Lozère 48) pour réaliser des confitures, pâtes de fruits, coulis, compotes, jus et nectar.
          ...
          des produits sains, bio ou issus du commerce équitable.
          ...
          forme, goût et couleur selon vos souhaits et les produits disponibles.


          </span>
          <span>Une question ou une envie, contactez moi ou passez à la boutique !</span>
        </div>
    </div>
  </div>
</template>
...
export default {
  head() {
    const title = `Présentation - Pâtisseries & Biscuits - Un Goût de Liberté`;
    return {
      title: title,
      meta: [{
        hid: 'title',
        ...
        hid: 'description',
        name: 'description',
        content: `Présentation - Un Goût de Liberté - Vente en Ligne de Pâtisseries et Biscuits artisanaux faits à CHILHAC (43380) par Justine DUMESNIL`,
      }]
    }
  }
}
